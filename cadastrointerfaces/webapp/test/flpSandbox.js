		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Cadastro de Interfaces",
									"targetURL": "#yellowcomcadastrointerfaces-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"yellowcomcadastrointerfaces-display": {
								"semanticObject": "yellowcomcadastrointerfaces",
								"action": "display",
								"description": "Cadastro de Interfaces",
								"title": "Cadastro de Interfaces",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=yellow.com.cadastrointerfaces",
									"url": sap.ui.require.toUrl("yellow/com/cadastrointerfaces")
								}
							}
						}
					}
